...
public class Stafflist extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setForeground(new java.awt.Color(0, 9, 246));
        jLabel1.setText("Staff List");

        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"NV01", "Nguyễn Nghiệm", "Việt Nam", "Male", "Maried"},
                {"NV02", "Lê Thi Hương Thảo", "Singapore", "Female", "Married"},
        ...
        jTable1.setSelectionBackground(new java.awt.Color(255, 49, 72));
        jScrollPane1.setViewportView(jTable1);

        jButton1.setBackground(new java.awt.Color(255, 23, 35));
        ...
        jButton2.setBackground(new java.awt.Color(240, 16, 20));
